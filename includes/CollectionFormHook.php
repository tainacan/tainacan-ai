...
class CollectionFormHook {
    ...
    public function render_form(): string {
        ...
        <p class="help">
            ...
            echo wp_kses_post(
                sprintf(
                    ...
                    __('Override the site-wide extraction behavior for this collection. Leave blank to use <a href="%s">Tainacan AI settings</a>. Enable extraction per metadata on each metadata edition form.', 'tainacan-ai'),
        ...
        <p class="help">
            <?php
            esc_html_e(
                'Write role, domain context, and extraction priorities here. The plugin appends global rules, evidence rules, metadata field blocks, and output keys automatically at analysis time.',
                'tainacan-ai'
            );
            ?>
        </p>
